...
work on this, move code from dashboard controller here noobie.

**/

angular.module('dashboardApp.services')
    .service('widgetLoader', ['$rootScope', '$q', '$compile', 'lazyDirectiveLoader', function($rootScope, $q, $compile, lazyDirectiveLoader) {
